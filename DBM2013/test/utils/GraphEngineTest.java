...
//      }
      ...
      RankingController rankingController = Lookup.getDefault().lookup(RankingController.class);
        ...
        try {
        	File pdfFile = new File("coAuthorsGraphBasedOnKeywordVectors.pdf");
        	File gexfFile = new File("coAuthorsGraphBasedOnKeywordVectors.gexf");
        	ec.exportFile(pdfFile); //ec.exportFile(new File("coAuthorsGraphBasedOnKeywordVectors.pdf"));
