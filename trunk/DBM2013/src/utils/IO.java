...
public class IO {
	...
	/**
	 * FIXME: stampa su file, percorso e nome statici, della matrice DocumentTermMatrix
	 ...
	 * @throws Exception
	 */
	public static ArrayList<TreeMap<String, Double>> readDocumentTermMatrixFromFile(String path) throws Exception{
